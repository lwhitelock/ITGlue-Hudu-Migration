...
$NewHuduConfigurationTypeList = [pscustomobject]@{list = $ITGConfigurationTypes | Group-Object type | Select @{n='name';e={$_.name}}, @{n='list_items_attributes'; e={ $_.Group.attributes | select name } }}
...
$NewHuduConfigurationStatusList = [pscustomobject]@{list = $ITGConfigurationStatuses | Group-Object type | Select @{n='name';e={$_.name}}, @{n='list_items_attributes'; e={ $_.Group.attributes | select name } }}
...
$NewHuduConfigurationManufacturerList = [pscustomobject]@{list = $ITGConfigurationManufacturers | Group-Object type | Select @{n='name';e={$_.name}}, @{n='list_items_attributes'; e={ $_.Group.attributes | select name } }}
...
$NewHuduConfigurationModelsList = [pscustomobject]@{list = $ITGConfigurationModels | Group-Object type | Select @{n='name';e={$_.name}}, @{n='list_items_attributes'; e={ $_.Group.attributes | select name } }}
...
$NewHuduConfigurationOSesList = [pscustomobject]@{list = $ITGConfigurationOSes | Group-Object type | Select @{n='name';e={$_.name}}, @{n='list_items_attributes'; e={ $_.Group.attributes | select name } }}
...
$NewHuduConfigurationPlatformList = [pscustomobject]@{list = $ITGConfigurationPlatforms | Group-Object type | Select @{n='name';e={$_.name}}, @{n='list_items_attributes'; e={ $_.Group.attributes | select name } }}
